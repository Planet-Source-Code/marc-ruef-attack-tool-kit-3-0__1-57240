...
Begin VB.Form frmAttackEditor 
   ...
   Begin VB.Frame fraClassification 
      ...
      Begin VB.TextBox txtRisk 
         ...
         MaxLength       =   2
         TabIndex        =   37
         ToolTipText     =   $"frmAttackEditor.frx":18D4
         Top             =   2040
         Width           =   375
      End
      Begin VB.TextBox txtImpact 
         ...
         MaxLength       =   2
         TabIndex        =   36
         ToolTipText     =   $"frmAttackEditor.frx":19A4
         Top             =   1680
         Width           =   375
      End
      Begin VB.TextBox txtSimplicity 
         ...
         MaxLength       =   2
         TabIndex        =   35
         ToolTipText     =   $"frmAttackEditor.frx":1AA9
         Top             =   1320
         Width           =   375
      End
      Begin VB.TextBox txtPopularity 
         ...
         MaxLength       =   2
         TabIndex        =   34
         ToolTipText     =   $"frmAttackEditor.frx":1BEF
         Top             =   960
         Width           =   375
      End
      Begin MSComctlLib.Slider sldPopularity 
         ...
         Left            =   960
         TabIndex        =   40
         ToolTipText     =   $"frmAttackEditor.frx":1CC9
         Top             =   960
         Width           =   2535
         _ExtentX        =   4471
         _ExtentY        =   450
      ...
      Begin MSComctlLib.Slider sldSimplicity 
         ...
         Left            =   960
         TabIndex        =   41
         ToolTipText     =   $"frmAttackEditor.frx":1DA3
         Top             =   1320
         Width           =   2535
         _ExtentX        =   4471
         _ExtentY        =   450
      ...
      Begin MSComctlLib.Slider sldImpact 
         ...
         Left            =   960
         TabIndex        =   47
         ToolTipText     =   $"frmAttackEditor.frx":1EE9
         Top             =   1680
         Width           =   2535
         _ExtentX        =   4471
         _ExtentY        =   450
      ...
      Begin MSComctlLib.Slider sldRisk 
         ...
         Left            =   960
         TabIndex        =   55
         ToolTipText     =   $"frmAttackEditor.frx":1FEE
         Top             =   2040
         Width           =   2535
         _ExtentX        =   4471
         _ExtentY        =   450
   ...
   Begin VB.Frame fraSources 
      ...
      Begin VB.CommandButton cmdUSCERTTA 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":20BE
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton cmdSecurityTracker 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":2448
         Style           =   1  'Graphical
         TabIndex        =   118
      ...
      Begin VB.CommandButton cmdRHSA 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":27D2
         Style           =   1  'Graphical
         TabIndex        =   134
      ...
      Begin VB.CommandButton cmdNetBSDSA 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":2B5C
         Style           =   1  'Graphical
         TabIndex        =   132
      ...
      Begin VB.CommandButton cmdMSSB 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":2EE6
         Style           =   1  'Graphical
         TabIndex        =   128
      ...
      Begin VB.CommandButton cmdMSKB 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":3270
         Style           =   1  'Graphical
         TabIndex        =   130
      ...
      Begin VB.CommandButton cmdISSXForce 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":35FA
         Style           =   1  'Graphical
         TabIndex        =   126
      ...
      Begin VB.CommandButton cmdCIAC 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":3984
         Style           =   1  'Graphical
         TabIndex        =   136
      ...
      Begin VB.CommandButton cmdCERTVU 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":3D0E
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton cmdCERT 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":4098
         Style           =   1  'Graphical
         TabIndex        =   92
      ...
      Begin VB.CommandButton cmdArachnIDS 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":4422
         Style           =   1  'Graphical
         TabIndex        =   122
      ...
      Begin VB.CommandButton cmdOSVDB 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":47AC
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton cmdSecurityFocus 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":4B36
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.CommandButton cmdSnort 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":4EC0
         Style           =   1  'Graphical
         TabIndex        =   120
      ...
      Begin VB.CommandButton cmdSecuriTeamURL 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":524A
         Style           =   1  'Graphical
         TabIndex        =   116
      ...
      Begin VB.CommandButton cmdHeiseNews 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":55D4
         Style           =   1  'Graphical
         TabIndex        =   112
      ...
      Begin VB.CommandButton cmdScip 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":595E
         Style           =   1  'Graphical
         TabIndex        =   108
      ...
      Begin VB.CommandButton cmdSecunia 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":5CE8
         Style           =   1  'Graphical
         TabIndex        =   104
      ...
      Begin VB.CommandButton cmdCVE 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":6072
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton cmdLiterature 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":63FC
         Style           =   1  'Graphical
         TabIndex        =   146
      ...
      Begin VB.CommandButton cmdMisc 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":6786
         Style           =   1  'Graphical
         TabIndex        =   138
      ...
      Begin VB.CommandButton cmdNessus 
         ...
         Height          =   285
         Left            =   3000
         Picture         =   "frmAttackEditor.frx":6B10
         Style           =   1  'Graphical
         TabIndex        =   124
      ...
      Begin VB.CommandButton cmdHeiseSecurity 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":6E9A
         Style           =   1  'Graphical
         TabIndex        =   114
      ...
      Begin VB.CommandButton cmdAeraSec 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":7224
         Style           =   1  'Graphical
         TabIndex        =   110
      ...
      Begin VB.CommandButton cmdTecChannel 
         ...
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":75AE
         Style           =   1  'Graphical
         TabIndex        =   106
   ...
   Begin VB.Frame fraSolution 
      ...
      Begin VB.CommandButton cmdAddSolution 
         Height          =   255
         Left            =   6600
         Picture         =   "frmAttackEditor.frx":7938
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   360
         Width           =   255
      ...
      Begin VB.TextBox txtSolution 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   31
         ToolTipText     =   $"frmAttackEditor.frx":7CC2
         Top             =   360
         Width           =   5535
      End
      Begin VB.Label lblLabel 
   ...
   Begin VB.Frame fraExploitation 
      ...
      Begin MSComctlLib.ImageList imlFileSources 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAttackEditor.frx":7D6B
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAttackEditor.frx":8105
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAttackEditor.frx":849F
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAttackEditor.frx":8839
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmAttackEditor.frx":8BD3
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin VB.CommandButton cmdExploitURLGo 
         Height          =   285
         Left            =   6480
         Picture         =   "frmAttackEditor.frx":8F6D
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.TextBox txtBugCheckTools 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   23
         ToolTipText     =   $"frmAttackEditor.frx":92F7
         Top             =   600
         Width           =   6735
      End
      ...
      Begin VB.Label lblExploitWebSearch 
         ...
         Height          =   195
         Left            =   1560
         MouseIcon       =   "frmAttackEditor.frx":93B6
   ...
   Begin VB.Frame fraDescription 
      ...
      Begin VB.CommandButton cmdDescriptionWizard 
         Height          =   255
         Left            =   6600
         Picture         =   "frmAttackEditor.frx":96C0
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.TextBox txtDescription 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   17
         ToolTipText     =   $"frmAttackEditor.frx":9A4A
         Top             =   2040
         Width           =   5295
      End
      Begin VB.Label lblLabel 
      ...
      Begin VB.Image imgVulnerabilityClass 
         Height          =   240
         Left            =   4200
         Picture         =   "frmAttackEditor.frx":9AF4
         ToolTipText     =   "Unknown"
         Top             =   1080
         Width           =   240
      End
   ...
   Begin VB.Frame fraAttackData 
      ...
      Begin VB.CommandButton cmdAddRequest 
         Height          =   255
         Left            =   6360
         Picture         =   "frmAttackEditor.frx":9C3E
         Style           =   1  'Graphical
         TabIndex        =   189
      ...
      Begin VB.CommandButton cmdAddPort 
         Height          =   255
         Left            =   2880
         Picture         =   "frmAttackEditor.frx":9FC8
         Style           =   1  'Graphical
         TabIndex        =   6
   ...
   Begin MSComctlLib.ImageList imlVulnerabilityClassIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   14
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":A352
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":A4AC
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":A606
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":A760
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":A8BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":AA14
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":AB6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":ACC8
            Key             =   ""
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":AE22
            Key             =   ""
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":AF7C
            Key             =   ""
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":B0D6
            Key             =   ""
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":B230
            Key             =   ""
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":B38A
            Key             =   ""
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmAttackEditor.frx":B4E4
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub AddRequestToTextBox(strCommand As String)
    ...
    'Save the textbox content into a string to increase the access speed
    strProcedureTextBoxContent = txbProcedureTextBoxName.Text
    ...
    If plugin_version_increased = False Then
        If LenB(strPluginVersion) Then
            ...
            If intValueCount = 0 Then
                ...
                txtPluginVersion.Text = plugin_version
            Else
                plugin_version = strMinorNumber(0) & "." & (strMinorNumber(1) + 1)
                txtPluginVersion.Text = plugin_version
            End If
        Else
            plugin_version = "1.0"
